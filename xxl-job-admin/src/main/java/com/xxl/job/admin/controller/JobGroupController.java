...
public class JobGroupController {
    ...
    public ReturnT<String> save(XxlJobGroup xxlJobGroup) {
        ...
        int ret = groupService.save(xxlJobGroup);
    ...
    public ReturnT<String> update(XxlJobGroup xxlJobGroup) {
        ...
        int ret = groupService.update(xxlJobGroup);
        return (ret > 0) ? ReturnT.SUCCESS : ReturnT.FAIL;
    }
    ...
    public ReturnT<String> remove(int id) {
        ...
        // valid
        int count = infoService.pageListCount(0, 10, id, -1, null, null, null);
        if (count > 0) {
            return new ReturnT<String>(500, I18nUtil.getString("jobgroup_del_limit_0"));
        }

        List<XxlJobGroup> allList = groupService.findAll();
        if (allList.size() == 1) {
            return new ReturnT<String>(500, I18nUtil.getString("jobgroup_del_limit_1"));
        }

        int ret = groupService.remove(id);
        return (ret > 0) ? ReturnT.SUCCESS : ReturnT.FAIL;
    }
    ...
    public ReturnT<XxlJobGroup> loadById(int id) {
        XxlJobGroup jobGroup = groupService.load(id);
